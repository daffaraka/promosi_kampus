                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <h3 class="card-title col-6">
                                <a href="#" class="btn btn-success"> + Tambah Penjadwalan</a>
                    ...
                    <div class="card-body p-0 table table-responsive" style="margin: 20px">
                        <table id="previewAkun" class="table table-striped table-bordered   display" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>kriteria manakah yang menurut anda lebih penting dalam menentukan media promosi?
                                    </td>
                                    ...
                                    <td> <a href='#'><i class='fas fa-edit fa-lg'></i></a> <a
                                            style='border: none; background-color:transparent;' class='hapusData'
                                            data-id='$akun_val->id' data-url='#'><i
